...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if KELP in state.order_depths and not self.already_bought_kelp:
            ...
            if len(order_depth.sell_orders) > 0:
                ...
                result[KELP] = [Order(KELP, best_ask_price, 1)]
            # If no asks available, create a market buy order at a high price
            else:
                result[KELP] = [Order(KELP, 10000, 1)]  # High price to ensure it fills
